...
public class AccountSolutionOnboardingFlowTest extends BaseTest {
    ...
    private ThreeAAccountSolutionProfilePage threeAAccountSolutionProfilePage;
    ...
    public void testFillPersonalAndInvestmentProfile() throws InterruptedException {
        ...
        Allure.step(
                "Choose FZ Account Solution", () -> {
                    threeAAccountSolutionProfilePage = chooseFzSolutionPage
                            .clickChooseThreeAFzAccountSolutionButtonLocator();
                    Assert.assertTrue(
    ...
    public void testBalancedProfileAndProductSelection() throws InterruptedException {
        Allure.step(
                "Change the investment profile to 'Balanced'", () -> {
                    transferingYourCapitalPage = threeAAccountSolutionProfilePage
                            .clickSelectContinueFz();
                }
        );
