...
public class FzGrowthOnboardingFlowTest extends BaseTest {
    ...
    public void testBalancedProfileAndProductSelection() throws InterruptedException {
        Allure.step(
                "Change the investment profile to 'Balanced'", () -> {
                    ...
                    Assert.assertTrue(
                            getDriver().getPageSource().contains("Your risk profile corresponds to a strategy where higher price and/or foreign exchange gains are more heavily weighted than regular income"),
                            "Text 'Your risk profile corresponds to a Growth Gains strategy' not found on screen."
                    );
                }
        );
