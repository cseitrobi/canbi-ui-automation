...
public class BalancedProfilePage extends BasePage {
    private WebElement balancedSolution;
     ...
     */
    protected BalancedProfilePage(AppiumDriver driver, Map<String, String> locators) {
    ...
    private void initializeElements() {
        ...
        String balancedSolutionLocator = locators.get("product-selection-balanced-solution");
        balancedSolution = wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.xpath(balancedSolutionLocator)));
    ...
    public BalancedProfilePage clickBalancedSolution() {
        balancedSolution.click();
        try {
            Thread.sleep(1000);
    ...
    public BalancedProfilePage clickConfirmButton() {
        confirmButton.click();
        return this;
    }
