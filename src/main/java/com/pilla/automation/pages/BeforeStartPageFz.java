...
public class BeforeStartPageFz extends BasePage {
     ...
     */
    protected BeforeStartPageFz(AppiumDriver driver, Map<String, String> locators) {
        super(driver, locators);
        intializeElements();
    }

    private void intializeElements() {
        String beforeStartButtonLocator = locators.get("before-start-start-button-fz");
    ...
    public PersonalSituationPageFz clickBeforeStartButton() {
        beforeStartButton.click();
        return new PersonalSituationPageFz(driver, locators);
    }
}
